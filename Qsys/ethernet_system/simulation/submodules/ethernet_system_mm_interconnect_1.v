// ethernet_system_mm_interconnect_1.v
...
`timescale 1 ps / 1 ps
module ethernet_system_mm_interconnect_1 (
	...
	ethernet_system_mm_interconnect_1_router router (
	...
	ethernet_system_mm_interconnect_1_router_001 router_001 (
	...
	ethernet_system_mm_interconnect_1_router_001 router_002 (
	...
	ethernet_system_mm_interconnect_1_router_001 router_003 (
	...
	ethernet_system_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (clk_clk_clk),                                       //        clk.clk
		.reset              (ethernet_bridge_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	ethernet_system_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (clk_clk_clk),                                       //       clk.clk
		.reset               (ethernet_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ethernet_system_mm_interconnect_1_cmd_mux cmd_mux_001 (
		.clk                 (clk_clk_clk),                                       //       clk.clk
		.reset               (ethernet_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ethernet_system_mm_interconnect_1_cmd_mux cmd_mux_002 (
		.clk                 (clk_clk_clk),                                       //       clk.clk
		.reset               (ethernet_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ethernet_system_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (clk_clk_clk),                                       //       clk.clk
		.reset              (ethernet_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ethernet_system_mm_interconnect_1_rsp_demux rsp_demux_001 (
		.clk                (clk_clk_clk),                                       //       clk.clk
		.reset              (ethernet_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ethernet_system_mm_interconnect_1_rsp_demux rsp_demux_002 (
		.clk                (clk_clk_clk),                                       //       clk.clk
		.reset              (ethernet_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ethernet_system_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (clk_clk_clk),                                       //       clk.clk
		.reset               (ethernet_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ethernet_system_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
