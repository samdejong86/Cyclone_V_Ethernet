...
alias com {
  echo "\[exec\] com"
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_mm_interconnect_0_avalon_st_adapter_error_adapter_0.sv"          -work error_adapter_0                 
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_dmaster_p2b_adapter.sv"                                    -work p2b_adapter                     
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_dmaster_b2p_adapter.sv"                                    -work b2p_adapter                     
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_dmaster_timing_adt.sv"                                     -work timing_adt                      
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_peripheral_subsystem_mm_interconnect_0_rsp_mux.sv"               -work rsp_mux                         
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                                         -work rsp_mux                         
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_peripheral_subsystem_mm_interconnect_0_rsp_demux.sv"             -work rsp_demux                       
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_peripheral_subsystem_mm_interconnect_0_cmd_mux.sv"               -work cmd_mux                         
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                                         -work cmd_mux                         
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_peripheral_subsystem_mm_interconnect_0_cmd_demux.sv"             -work cmd_demux                       
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_peripheral_subsystem_mm_interconnect_0_router_001.sv"            -work router_001                      
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_peripheral_subsystem_mm_interconnect_0_router.sv"                -work router                          
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_ethernet_subsystem_avalon_st_adapter_timing_adapter_0.sv"        -work timing_adapter_0                
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_ethernet_subsystem_avalon_st_adapter_timing_adapter_0_fifo.sv"   -work timing_adapter_0                
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_ethernet_subsystem_mm_interconnect_2_rsp_mux.sv"                 -work rsp_mux                         
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                                         -work rsp_mux                         
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_ethernet_subsystem_mm_interconnect_2_rsp_demux.sv"               -work rsp_demux                       
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_ethernet_subsystem_mm_interconnect_2_cmd_mux.sv"                 -work cmd_mux                         
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                                         -work cmd_mux                         
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_ethernet_subsystem_mm_interconnect_2_cmd_demux.sv"               -work cmd_demux                       
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_ethernet_subsystem_mm_interconnect_2_router_002.sv"              -work router_002                      
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_ethernet_subsystem_mm_interconnect_2_router.sv"                  -work router                          
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_ethernet_subsystem_mm_interconnect_1_rsp_mux.sv"                 -work rsp_mux                         
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                                         -work rsp_mux                         
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_ethernet_subsystem_mm_interconnect_1_rsp_demux.sv"               -work rsp_demux                       
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_ethernet_subsystem_mm_interconnect_1_cmd_mux.sv"                 -work cmd_mux                         
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                                         -work cmd_mux                         
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_ethernet_subsystem_mm_interconnect_1_cmd_demux.sv"               -work cmd_demux                       
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_ethernet_subsystem_mm_interconnect_1_router_001.sv"              -work router_001                      
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_ethernet_subsystem_mm_interconnect_1_router.sv"                  -work router                          
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_ethernet_subsystem_mm_interconnect_0_rsp_mux.sv"                 -work rsp_mux                         
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                                         -work rsp_mux                         
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_ethernet_subsystem_mm_interconnect_0_rsp_demux.sv"               -work rsp_demux                       
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_ethernet_subsystem_mm_interconnect_0_cmd_mux.sv"                 -work cmd_mux                         
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                                         -work cmd_mux                         
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_ethernet_subsystem_mm_interconnect_0_cmd_demux.sv"               -work cmd_demux                       
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_ethernet_subsystem_mm_interconnect_0_router_004.sv"              -work router_004                      
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_ethernet_subsystem_mm_interconnect_0_router.sv"                  -work router                          
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_mm_interconnect_0_rsp_mux_002.sv"                                -work rsp_mux_002                     
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                                         -work rsp_mux_002                     
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_mm_interconnect_0_rsp_mux_001.sv"                                -work rsp_mux_001                     
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                                         -work rsp_mux_001                     
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_mm_interconnect_0_rsp_mux.sv"                                    -work rsp_mux                         
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                                         -work rsp_mux                         
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_mm_interconnect_0_rsp_demux_002.sv"                              -work rsp_demux_002                   
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_mm_interconnect_0_rsp_demux.sv"                                  -work rsp_demux                       
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_mm_interconnect_0_cmd_mux_002.sv"                                -work cmd_mux_002                     
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                                         -work cmd_mux_002                     
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_mm_interconnect_0_cmd_mux_001.sv"                                -work cmd_mux_001                     
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                                         -work cmd_mux_001                     
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_mm_interconnect_0_cmd_mux.sv"                                    -work cmd_mux                         
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                                         -work cmd_mux                         
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_mm_interconnect_0_cmd_demux_002.sv"                              -work cmd_demux_002                   
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_mm_interconnect_0_cmd_demux_001.sv"                              -work cmd_demux_001                   
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_mm_interconnect_0_cmd_demux.sv"                                  -work cmd_demux                       
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_mm_interconnect_0_router_005.sv"                                 -work router_005                      
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_mm_interconnect_0_router_004.sv"                                 -work router_004                      
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_mm_interconnect_0_router_003.sv"                                 -work router_003                      
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_mm_interconnect_0_router_002.sv"                                 -work router_002                      
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_mm_interconnect_0_router_001.sv"                                 -work router_001                      
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_mm_interconnect_0_router.sv"                                     -work router                          
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                                             -work sdram_avl_0_agent_rsp_fifo      
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                                                        -work sdram_avl_0_agent               
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                                                 -work sdram_avl_0_agent               
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"                                                   -work sdram_avl_0_translator          
  ...
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_mm_interconnect_1.v"                                       -work mm_interconnect_1               
  ...
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_s0.v"                                                      -work s0                              
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_s0_mm_interconnect_0_router_007.sv"                        -work s0                              
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_s0_mm_interconnect_0_cmd_demux_002.sv"                     -work s0                              
  ...
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_s0_mm_interconnect_0.v"                                    -work s0                              
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"                                                       -work s0                              
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_s0_irq_mapper.sv"                                          -work s0                              
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_s0_mm_interconnect_0_cmd_demux_001.sv"                     -work s0                              
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/sequencer_reg_file.sv"                                                               -work s0                              
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_s0_mm_interconnect_0_router_002.sv"                        -work s0                              
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_s0_mm_interconnect_0_router_010.sv"                        -work s0                              
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_reorder_memory.sv"                                                     -work s0                              
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_s0_mm_interconnect_0_router_009.sv"                        -work s0                              
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_s0_mm_interconnect_0_router.sv"                            -work s0                              
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_s0_mm_interconnect_0_avalon_st_adapter_error_adapter_0.sv" -work s0                              
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_s0_mm_interconnect_0_router_003.sv"                        -work s0                              
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_s0_mm_interconnect_0_cmd_mux_003.sv"                       -work s0                              
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/sequencer_trk_mgr.sv"                                                                -work s0                              
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_s0_mm_interconnect_0_cmd_demux_003.sv"                     -work s0                              
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_s0_mm_interconnect_0_rsp_mux_001.sv"                       -work s0                              
  ...
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_s0_mm_interconnect_0_avalon_st_adapter.v"                  -work s0                              
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/sequencer_scc_sv_phase_decode.v"                                                     -work s0                              
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_s0_mm_interconnect_0_rsp_demux_002.sv"                     -work s0                              
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                                         -work s0                              
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_s0_mm_interconnect_0_cmd_demux.sv"                         -work s0                              
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/sequencer_scc_reg_file.v"                                                            -work s0                              
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_s0_mm_interconnect_0_cmd_mux_002.sv"                       -work s0                              
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_s0_mm_interconnect_0_router_001.sv"                        -work s0                              
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_s0_mm_interconnect_0_rsp_mux.sv"                           -work s0                              
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/sequencer_scc_sv_wrapper.sv"                                                         -work s0                              
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_s0_mm_interconnect_0_router_005.sv"                        -work s0                              
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_s0_mm_interconnect_0_router_008.sv"                        -work s0                              
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_s0_mm_interconnect_0_cmd_mux.sv"                           -work s0                              
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_s0_mm_interconnect_0_rsp_mux_002.sv"                       -work s0                              
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_traffic_limiter.sv"                                                    -work s0                              
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_s0_mm_interconnect_0_router_004.sv"                        -work s0                              
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_p0_clock_pair_generator.v"                                 -work p0                              
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_p0_acv_hard_addr_cmd_pads.v"                               -work p0                              
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_p0_acv_hard_memphy.v"                                      -work p0                              
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_p0_acv_ldc.v"                                              -work p0                              
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_p0_acv_hard_io_pads.v"                                     -work p0                              
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_p0_generic_ddio.v"                                         -work p0                              
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_p0_reset.v"                                                -work p0                              
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_p0_reset_sync.v"                                           -work p0                              
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_p0_phy_csr.sv"                                             -work p0                              
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_p0_iss_probe.v"                                            -work p0                              
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_p0.sv"                                                     -work p0                              
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_p0_altdqdqs.v"                                             -work p0                              
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram_pll0.sv"                                                   -work pll0                            
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_peripheral_subsystem_mm_interconnect_0.v"                        -work mm_interconnect_0               
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_peripheral_subsystem_sys_clk_timer.v"                            -work sys_clk_timer                   
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_peripheral_subsystem_performance_counter.v"                      -work performance_counter             
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_peripheral_subsystem_led_pio.v"                                  -work led_pio                         
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_peripheral_subsystem_jtag_uart.v"                                -work jtag_uart                       
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_peripheral_subsystem_high_res_timer.v"                           -work high_res_timer                  
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_peripheral_subsystem_button_pio.v"                               -work button_pio                      
  ...
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_ethernet_subsystem_mm_interconnect_2.v"                          -work mm_interconnect_2               
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_ethernet_subsystem_mm_interconnect_1.v"                          -work mm_interconnect_1               
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_ethernet_subsystem_mm_interconnect_0.v"                          -work mm_interconnect_0               
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_ethernet_subsystem_tse_mac.v"                                    -work tse_mac                         
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_ethernet_subsystem_sgdma_tx.v"                                   -work sgdma_tx                        
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_ethernet_subsystem_sgdma_rx.v"                                   -work sgdma_rx                        
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_avalon_mm_bridge.v"                                                           -work ethernet_bridge                 
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_ethernet_subsystem_descriptor_memory.v"                          -work descriptor_memory               
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_cpu_cpu_debug_slave_sysclk.v"                                    -work cpu                             
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_cpu_cpu_mult_cell.v"                                             -work cpu                             
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_cpu_cpu_debug_slave_wrapper.v"                                   -work cpu                             
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_cpu_cpu.vo"                                                      -work cpu                             
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_cpu_cpu_debug_slave_tck.v"                                       -work cpu                             
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_cpu_cpu_test_bench.v"                                            -work cpu                             
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/eth_std_main_system_irq_mapper.sv"                                                   -work irq_mapper                      
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_mm_interconnect_0.v"                                             -work mm_interconnect_0               
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_sysid.v"                                                         -work sysid                           
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_sdram.v"                                                         -work sdram                           
  ...
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_enet_pll.vo"                                                     -work enet_pll                        
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/eth_std_main_system_cpu.v"                                                           -work cpu                             
