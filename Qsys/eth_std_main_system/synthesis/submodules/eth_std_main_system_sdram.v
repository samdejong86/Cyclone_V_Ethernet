...
`timescale 1 ps / 1 ps
module eth_std_main_system_sdram (
	...
	eth_std_main_system_sdram_pll0 pll0 (
	...
	eth_std_main_system_sdram_p0 p0 (
		.global_reset_n             (global_reset_n),                                                                                                                                                                            //        global_reset.reset_n
	...
	eth_std_main_system_sdram_s0 s0 (
		.avl_clk                 (p0_avl_clk_clk),                               //          avl_clk.clk
		.avl_reset_n             (p0_avl_reset_reset),                           //        avl_reset.reset_n
		.scc_clk                 (p0_scc_clk_clk),                               //          scc_clk.clk
	...
	eth_std_main_system_sdram_dmaster #(
		.USE_PLI     (0),
		.PLI_PORT    (50000),
		.FIFO_DEPTHS (2)
	) dmaster (
	...
	eth_std_main_system_sdram_mm_interconnect_1 mm_interconnect_1 (
