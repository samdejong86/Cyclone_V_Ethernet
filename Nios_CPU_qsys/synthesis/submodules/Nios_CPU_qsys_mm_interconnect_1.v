...
module Nios_CPU_qsys_mm_interconnect_1 (
	...
	wire  [82:0] jtag_uart_0_avalon_jtag_slave_agent_rf_source_data;                 // jtag_uart_0_avalon_jtag_slave_agent:rf_source_data -> jtag_uart_0_avalon_jtag_slave_agent_rsp_fifo:in_data
	...
	wire  [82:0] jtag_uart_0_avalon_jtag_slave_agent_rsp_fifo_out_data;              // jtag_uart_0_avalon_jtag_slave_agent_rsp_fifo:out_data -> jtag_uart_0_avalon_jtag_slave_agent:rf_sink_data
	...
	wire  [81:0] cmd_mux_src_data;                                                   // cmd_mux:src_data -> jtag_uart_0_avalon_jtag_slave_agent:cp_data
	...
	wire  [81:0] cmd_mux_001_src_data;                                               // cmd_mux_001:src_data -> sysid_control_slave_agent:cp_data
	wire         cmd_mux_001_src_ready;                                              // sysid_control_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [3:0] cmd_mux_001_src_channel;                                            // cmd_mux_001:src_channel -> sysid_control_slave_agent:cp_channel
	...
	wire   [3:0] cmd_mux_002_src_channel;                                            // cmd_mux_002:src_channel -> sys_clk_timer_s1_agent:cp_channel
	...
	wire   [3:0] cmd_mux_003_src_channel;                                            // cmd_mux_003:src_channel -> high_res_timer_s1_agent:cp_channel
	...
	wire  [81:0] pb_cpu_to_io_m0_agent_cp_data;                                      // pb_cpu_to_io_m0_agent:cp_data -> router:sink_data
	...
	wire  [81:0] jtag_uart_0_avalon_jtag_slave_agent_rp_data;                        // jtag_uart_0_avalon_jtag_slave_agent:rp_data -> router_001:sink_data
	...
	wire  [81:0] sysid_control_slave_agent_rp_data;                                  // sysid_control_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [81:0] router_src_data;                                                    // router:src_data -> pb_cpu_to_io_m0_limiter:cmd_sink_data
	wire         router_src_ready;                                                   // pb_cpu_to_io_m0_limiter:cmd_sink_ready -> router:src_ready
	wire   [3:0] router_src_channel;                                                 // router:src_channel -> pb_cpu_to_io_m0_limiter:cmd_sink_channel
	...
	wire  [81:0] pb_cpu_to_io_m0_limiter_cmd_src_data;                               // pb_cpu_to_io_m0_limiter:cmd_src_data -> cmd_demux:sink_data
	wire         pb_cpu_to_io_m0_limiter_cmd_src_ready;                              // cmd_demux:sink_ready -> pb_cpu_to_io_m0_limiter:cmd_src_ready
	wire   [3:0] pb_cpu_to_io_m0_limiter_cmd_src_channel;                            // pb_cpu_to_io_m0_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [81:0] rsp_mux_src_data;                                                   // rsp_mux:src_data -> pb_cpu_to_io_m0_limiter:rsp_sink_data
	wire         rsp_mux_src_ready;                                                  // pb_cpu_to_io_m0_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire   [3:0] rsp_mux_src_channel;                                                // rsp_mux:src_channel -> pb_cpu_to_io_m0_limiter:rsp_sink_channel
	...
	wire  [81:0] pb_cpu_to_io_m0_limiter_rsp_src_data;                               // pb_cpu_to_io_m0_limiter:rsp_src_data -> pb_cpu_to_io_m0_agent:rp_data
	wire         pb_cpu_to_io_m0_limiter_rsp_src_ready;                              // pb_cpu_to_io_m0_agent:rp_ready -> pb_cpu_to_io_m0_limiter:rsp_src_ready
	wire   [3:0] pb_cpu_to_io_m0_limiter_rsp_src_channel;                            // pb_cpu_to_io_m0_limiter:rsp_src_channel -> pb_cpu_to_io_m0_agent:rp_channel
	...
	wire   [3:0] pb_cpu_to_io_m0_limiter_cmd_valid_data;                             // pb_cpu_to_io_m0_limiter:cmd_src_valid -> cmd_demux:sink_valid
